...
\usepackage{fontspec}
\setmainfont{SabonNext LT}
%\setmainfont{Averia Serif Libre}
%\setmainfont{Chinzel}
%\setmainfont{Cormorant Unicase}
%\setmainfont{FrutigerNextLT}
...
\newcommand{\htarget}[2]{\protect\hypertarget{#1}{{\color{apink}#2}\label{#1}}}
...
\renewcommand\marginpar[2][]{%
    \oldmarginpar{\mpjustification {\small #2}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Bunch of commands for stattables
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 
\newcommand{\ndice}{%
    \hspace{1em}\includegraphics[height=\fontcharht\font`\B]{./icons/w20.pdf}\hspace{1em}
    }

\newcommand{\nth}[1]{% 
    {\color{agrey}\tiny\textsc{\textbf{#1}}} 
    }
...
\newcommand{\Melee}{%
    \hspace{1em}\includegraphics[height=1.2\fontcharht\font`\X]{./icons/meleesvg.pdf}\hspace{1em}
    }

\newcommand{\Missile}{%
    \hspace{1em}\includegraphics[height=1.2\fontcharht\font`\X]{./icons/bow.pdf}\hspace{1em}
    }
...
\newcommand{\statsheader}[4]{%
    \midrule[0.05ex]
    \multicolumn{8}{l}{\hspace{5mm}
                    Wounds {\normalsize{#1 }} 
           \ndice Movement {\normalsize{#2 }}
           \ndice     Save {\normalsize{#3+}}
           \ndice  Bravery {\normalsize{#4 }}
...
\newcommand{\ttitle}[1]{%
    \multicolumn{8}{l}{
        \textsc{\normalsize{\color{ablue} #1 }}} \\[1ex]
    }

\newcommand{\statstable}[1]{%
    \begin{scriptsize}
    \noindent
    \begin{tabular}{clcccccc} %8 cols
        \toprule
        \nth{Type} & \nth{Weapon} & \nth{Range} & \nth{Attacks} & \nth{To Hit} & 
        \nth{To Wound} & \nth{Rend} & \nth{Damage} \\
        \midrule
